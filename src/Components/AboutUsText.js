...
<div className="paragr">
    <p className="par4"> «Iodo Band» - это кавер-группа, выступающая на самых значимых событиях, будь то свадьбы, корпоративы, банкеты, дни города и прочие праздники «с размахом». 
